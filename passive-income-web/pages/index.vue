  ...
  <div class="container mx-auto px-4 py-8">
    <section class="text-center py-16 md:py-24 bg-gradient-to-r from-primary/5 to-secondary/5 rounded-lg shadow-lg mb-12 dark:from-neutral-darkest/20 dark:to-neutral-dark/20">
      <h1 class="text-4xl md:text-5xl font-extrabold text-neutral-darkest dark:text-neutral-lightest leading-tight mb-4 tracking-tight">
        ITスキルで、不労所得を創造する。
        <span class="block text-xl md:text-2xl font-semibold text-neutral-darkest dark:text-neutral-light mt-3">
          現役エンジニアが挑戦する、資産形成へのリアルな道のり
        </span>
      </h1>
      <p class="text-lg md:text-xl text-neutral-darkest/80 dark:text-neutral-light/80 mb-8 max-w-3xl mx-auto">
    ...
    <section class="py-12 mb-12">
      ...
      <div class="grid md:grid-cols-3 gap-8">
        <div class="bg-white dark:bg-neutral-dark shadow-md p-8 text-center hover:shadow-xl transition-shadow duration-300 transform hover:-translate-y-1">
          ...
          <p class="text-neutral-darkest/80 dark:text-neutral-light/80 text-sm">ウェブサイトのPV数や広告収益など、リアルなデータを毎月公開。良い時も悪い時も、すべてが学びの材料です。</p>
        </div>
        <div class="bg-white dark:bg-neutral-dark shadow-md p-8 text-center hover:shadow-xl transition-shadow duration-300 transform hover:-translate-y-1">
          ...
          <p class="text-neutral-darkest/80 dark:text-neutral-light/80 text-sm">Webサイト構築、自動化ツール開発、実際に使用している技術やコードを具体的に解説します。</p>
        </div>
        <div class="bg-white dark:bg-neutral-dark shadow-md p-8 text-center hover:shadow-xl transition-shadow duration-300 transform hover:-translate-y-1">
          ...
          <p class="text-neutral-darkest/80 dark:text-neutral-light/80 text-sm">収益化を加速させるためのオリジナルツールやアプリケーション開発の全過程を、アイデア出しから実装まで記録します。</p>
        </div>
      </div>
    </section>

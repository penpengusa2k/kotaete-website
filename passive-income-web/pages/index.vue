<template>
  <div class="container mx-auto px-4 py-8">
    <section class="text-center py-16 md:py-24 bg-gradient-to-r from-primary/5 to-secondary/5 rounded-lg shadow-lg mb-12">
      <h1 class="text-4xl md:text-5xl font-extrabold text-neutral-darkest leading-tight mb-4 tracking-tight">
        ITスキルで、不労所得を創造する。
        <span class="block text-xl md:text-2xl font-semibold text-neutral-dark mt-3">
          現役エンジニアが挑戦する、資産形成へのリアルな道のり
        </span>
      </h1>
      <p class="text-lg md:text-xl text-neutral-dark/80 mb-8 max-w-3xl mx-auto">
    ...
    <section class="py-12 mb-12">
      <h2 class="text-3xl font-bold text-center text-neutral-darkest mb-10">このサイトの3つの柱</h2>
      <div class="grid md:grid-cols-3 gap-8">
        <div class="bg-white rounded-lg shadow-md p-8 text-center hover:shadow-xl transition-shadow duration-300 transform hover:-translate-y-1">
          <span class="material-icons-outlined text-secondary text-5xl mb-4">bar_chart</span>
          <h3 class="text-xl font-semibold text-neutral-darkest mb-2">透明性のある実績公開</h3>
          <p class="text-neutral-dark/80 text-sm">ウェブサイトのPV数や広告収益など、リアルなデータを毎月公開。</p>
        </div>
        <div class="bg-white rounded-lg shadow-md p-8 text-center hover:shadow-xl transition-shadow duration-300 transform hover:-translate-y-1">
          <span class="material-icons-outlined text-primary text-5xl mb-4">code_blocks</span>
          <h3 class="text-xl font-semibold text-neutral-darkest mb-2">実践的な技術ノウハウ</h3>
          <p class="text-neutral-dark/80 text-sm">Webサイト構築、自動化ツール開発、実際に使用している技術やコードを具体的に解説します。</p>
        </div>
        <div class="bg-white rounded-lg shadow-md p-8 text-center hover:shadow-xl transition-shadow duration-300 transform hover:-translate-y-1">
          <span class="material-icons-outlined text-accent text-5xl mb-4">construction</span>
          <h3 class="text-xl font-semibold text-neutral-darkest mb-2">自作ツール開発記</h3>
          <p class="text-neutral-dark/80 text-sm">収益化を加速させるためのオリジナルツールやアプリケーション開発の全過程を、アイデア出しから実装まで記録します。</p>
        </div>
      </div>
    </section>

    <section class="py-12">
      <h2 class="text-3xl font-bold text-center text-neutral-darkest mb-10">最新の挑戦記録</h2>
      
      <div v-if="pending" class="text-center py-8 text-neutral-dark">
        <p>最新記事を読み込み中...</p>
      ...
      <div v-else-if="latestArticles && latestArticles.length > 0" class="grid grid-cols-1 gap-8 max-w-3xl mx-auto">
        <NuxtLink
          ...
          class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-shadow duration-300 flex flex-col md:flex-row group" style="text-decoration: none;"
        >
              ...
              <span class="flex items-center">
                ...
                <div class="flex flex-wrap gap-1.5">
                  <button
                    ...
                    class="px-2 py-0.5 bg-neutral-light text-neutral-darkest text-xs font-medium rounded-full hover:bg-primary/20 hover:text-primary-dark transition-colors duration-200 cursor-pointer"
                  >
                    {{ catName }}
                  </button>
                </div>
      ...
      <div v-else class="text-center py-8 text-neutral-dark">
